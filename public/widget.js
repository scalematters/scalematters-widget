(function () {
  ...
  // The embed snippet can land anywhere in the page (some CMS "footer HTML"
  // fields actually render into <head>, before document.body exists), so
  // don't touch document.body until it's actually there.
  function init() {
    var sessionId = uuid();
    var messages = [];
    var sending = false;
